    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_args', models.TextField(blank=True, null=True)),
                ('request_kwargs', models.CharField(max_length=1000)),
                ('response_content', models.TextField(max_length=10000)),
                ('response_content_json_str', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_template_params', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('packages', models.ManyToManyField(to='dashboard.Package')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_build_tags', models.TextField(blank=True, null=True, verbose_name='Release Build Tags')),
                ...
                ('major_milestones', models.TextField(blank=True, null=True, verbose_name='Major Milestones')),
                ('product_phases', models.TextField(blank=True, null=True, verbose_name='Release Stream Phases')),
